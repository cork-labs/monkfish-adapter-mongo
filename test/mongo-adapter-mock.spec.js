...
const MongoAdapterMock = require('../src/mongo-adapter-mock');
...
describe('MongoAdapterMock', function () {
  it('should be a function', function () {
    expect(MongoAdapterMock).to.be.a('function');
  });

  describe('connect()', function () {
    before(function () {
      this.subject = new MongoAdapterMock(logger, {uri: 'mongodb://localhost/mongo-adapter-test'});
    });
  ...
  describe('given a connection', function () {
    ...
    describe('collection()', function () {
      it('should expose the underlying collection object', async function () {
        ...
        expect(collection.namespace).to.match(/^[a-z0-9]{8}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{12}\.foo$/);
      });
    });
